...
["", "arkanoid.dart", , T, {
  ...
  main: [function() {
    var t1, t2, t3;
    t1 = document.querySelector("#platno");
    $.platno = t1;
    ...
    t2 = new T.Palka(null, null, null, null, null);
    t2.Palka$1($.platno);
    $.palka = t2;
    t2 = new T.Micek(null, null, null, null, null, null, null, null, null, null, null);
    t2.Micek$1($.platno);
    $.micek = t2;
    t2.x = 500;
    t2.y = 500;
    t2 = $.platno;
    t2.toString;
    t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, C.EventStreamProvider_mousemove._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone($.palka.get$move()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    $.get$herniObjekty().push($.palka);
    $.get$herniObjekty().push($.micek);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(100, 200, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(200, 200, 2, 2, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(300, 200, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(400, 200, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(500, 200, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(600, 200, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(700, 200, 2, 2, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(100, 400, 2, 1, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(200, 400, 2, 2, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(300, 400, 2, 0, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(400, 400, 2, 2, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(500, 400, 2, 2, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(600, 400, 2, 0, 200);
    $.get$cihly().push($.cihla);
    t2 = T.Cihla$();
    $.cihla = t2;
    t2.nastavParametry$5(700, 400, 2, 2, 200);
    $.get$cihly().push($.cihla);
    T.draw();
  ...
  draw: function() {
    ...
    t2 = $.get$herniObjekty();
    t2.toString;
    H.IterableMixinWorkaround_forEach(t2, new T.draw_closure());
    t2 = $.get$cihly();
    t2.toString;
    H.IterableMixinWorkaround_forEach(t2, new T.draw_closure0());
    t2 = $.get$pupy();
    t2.toString;
    H.IterableMixinWorkaround_forEach(t2, new T.draw_closure1());
    t2 = $.ctx;
    t2.fillStyle = "black";
    J.fillText$3$x(t2, "Pokusy: " + C.JSInt_methods.toString$0($.pokusy), 20, 20);
    J.fillText$3$x($.ctx, "Sk\u00f3re: " + C.JSNumber_methods.toString$0($.body), 20, 40);
    if ($.pokusy !== 0) {
      t1 = window;
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(T.loop$closure()));
    } else {
      t1 = $.ctx;
      t1.fillStyle = "black";
      J.fillText$3$x(t1, "Konec hry!", 400, 400);
    }
  },
  loop: [function(_) {
    var t1 = $.get$pupy();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure());
    t1 = $.get$pupy();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure0());
    t1 = $.get$pupy();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure1());
    t1 = $.get$efekty();
    t1.forEach$1(t1, new T.loop_closure2());
    t1 = $.get$cihly();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure3());
    $.micek.pohyb$0();
    if ($.get$cihly().length === 0) {
      T.randGen();
      T.randGen();
      T.randGen();
    }
    J.addAll$1$ax($.get$cihly(), $.get$noveCihly());
    J.set$length$asx($.get$noveCihly(), 0);
    t1 = $.get$mazaneCihly();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure4());
    J.set$length$asx($.get$mazaneCihly(), 0);
    t1 = $.get$mazanePower();
    t1.toString;
    H.IterableMixinWorkaround_forEach(t1, new T.loop_closure5());
    J.set$length$asx($.get$mazanePower(), 0);
    T.draw();
  }, "call$1", "loop$closure", 2, 0, 1],
  randGen: function() {
    var r, i, t1, t2, t3, p, t4, t5, c;
    r = C.C__JSRandom.nextInt$1(4) + 2;
    for (i = 0; i < r; ++i) {
      t1 = {};
      t2 = C.C__JSRandom.nextInt$1(7);
      t3 = C.C__JSRandom.nextInt$1(8);
      p = C.C__JSRandom.nextInt$1(3);
      t4 = C.C__JSRandom.nextInt$1(2);
      t5 = C.C__JSRandom.nextInt$1(19);
      c = new T.Cihla(null, null, null, null, null, null, null, null, null);
      c.sirka = 72;
      c.vyska = 34;
      c.id = $.get$cihly().length + 1;
      c.nastavParametry$5((t2 + 1) * 100, (t3 + 1) * 50, t4 + 1, p, (t5 + 1) * 50);
      t1.kolize_0 = false;
      t5 = $.get$cihly();
      t5.toString;
      H.IterableMixinWorkaround_forEach(t5, new T.randGen_closure(t1, c));
      if (!t1.kolize_0)
        $.get$noveCihly().push(c);
      else
        --i;
    }
  },
  draw_closure: {
    "": "Closure:11;",
    call$1: function(objekt) {
      return objekt.nakresliSe$1($.ctx);
    }
  },
  draw_closure0: {
    "": "Closure:11;",
  ...
  loop_closure: {
    "": "Closure:11;",
    call$1: function(objekt) {
      return objekt.pohyb$0();
    }
  },
  loop_closure0: {
    "": "Closure:11;",
    call$1: function(pup) {
      if ($.palka.kolizniTest$1(pup))
        pup.kolize$0();
    }
  },
  loop_closure1: {
    ...
    call$1: function(objekt) {
      var t1;
      if (objekt.get$sebran()) {
        t1 = $.get$efekty();
        if (t1.$index(t1, objekt) == null) {
          t1 = $.get$efekty();
          t1.$indexSet(t1, objekt, 0);
        }
        t1 = $.get$efekty();
        t1.$indexSet(t1, objekt, J.$add$ns(t1.$index(t1, objekt), objekt.cas));
        $.get$mazanePower().push(objekt);
      }
    }
  },
  loop_closure2: {
    "": "Closure:10;",
    call$2: function(objekt, value) {
      var t1 = C.JSNumber_methods._tdivFast$1(objekt.get$s().get$elapsedTicks() * 1000, 1000000);
      if (typeof value !== "number")
        return H.iae(value);
      if (t1 > value) {
        switch (objekt.id) {
  ...
  loop_closure3: {
    "": "Closure:11;",
    call$1: function(objekt) {
      if ($.micek.kolizniTest$1(objekt) && objekt.naraz$0())
        $.get$mazaneCihly().push(objekt);
    }
  },
  loop_closure4: {
    "": "Closure:11;",
    call$1: function(obj) {
      return J.remove$1$ax($.get$cihly(), obj);
    }
  },
  loop_closure5: {
    "": "Closure:11;",
    call$1: function(obj) {
      return J.remove$1$ax($.get$pupy(), obj);
    }
  },
  randGen_closure: {
    "": "Closure:11;box_0,c_1",
    call$1: function(objekt) {
      if (this.c_1.kolizniTest$1(objekt))
        this.box_0.kolize_0 = true;
    }
  },
  HerniObjekt: {
    "": "Object;x>,y>,sirka<,vyska<",
    kolizniTest$1: function(_obj) {
      var tento, t1, tamten, t2, t3, t4;
      tento = H.setRuntimeTypeInfo(new P.Rectangle(this.x, this.y, this.sirka, this.vyska), [null]);
      t1 = J.getInterceptor$x(_obj);
      tamten = H.setRuntimeTypeInfo(new P.Rectangle(t1.get$x(_obj), t1.get$y(_obj), _obj.get$sirka(), _obj.vyska), [null]);
      t1 = tento.left;
      t2 = tamten.left;
      if (typeof t1 !== "number")
        return t1.$le();
    ...
    nakresliSe$1: function(_ctx) {
      _ctx.fillStyle = this.barva;
      _ctx.fillRect(this.x, this.y, this.sirka, this.vyska);
      _ctx.fill();
    }
  },
  Palka: {
    "": "HerniObjekt;x,y,sirka,vyska,barva",
    move$1: [function(e) {
      var t1 = J.get$offset$x(e);
      this.x = t1.get$x(t1);
    }, "call$1", "get$move", 2, 0, 14],
    Palka$1: function(_can) {
      var t1, t2;
      this.sirka = 100;
      this.vyska = 15;
      t1 = J.getInterceptor$x(_can);
      t2 = t1.get$width(_can);
      if (typeof t2 !== "number")
        return t2.$tdiv();
      this.x = C.JSInt_methods._tdivFast$1(t2, 2) - 50;
      t1 = t1.get$height(_can);
      if (typeof t1 !== "number")
        return t1.$sub();
      this.y = t1 - 50;
      this.barva = "green";
  ...
  Micek: {
    "": "HerniObjekt;dx,dy,docasneX,docasneY,novaSirka,novaVyska,x,y,sirka,vyska,barva",
    nakresliSe$1: function(_ctx) {
      var t1, t2, t3;
      _ctx.fillStyle = this.barva;
      t1 = this.x;
    ...
    kolize$1: function(_obj) {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9;
      if (this.kolizniTest$1(_obj)) {
        t1 = this.sirka;
        if (typeof t1 !== "number")
          return t1.$div();
        t1 = t1 / 2 / Math.sqrt(2) * 2;
        this.novaSirka = t1;
        this.novaVyska = t1;
        t2 = this.x;
        t3 = this.sirka;
    ...
    pohyb$0: function() {
      ...
      t1 = $.get$cihly();
      t1.toString;
      H.IterableMixinWorkaround_forEach(t1, new T.Micek_pohyb_closure(this));
      t1 = this.x;
      t2 = this.dx;
      if (typeof t1 !== "number")
        return t1.$add();
    ...
    Micek$1: function(_can) {
      ...
      if (typeof t2 !== "number")
        return t2.$tdiv();
      this.x = C.JSInt_methods._tdivFast$1(t2, 2) - 5;
      t1 = t1.get$height(_can);
      if (typeof t1 !== "number")
        return t1.$tdiv();
      this.y = C.JSInt_methods._tdivFast$1(t1, 2) - 5;
      this.barva = "blue";
      this.dx = 3;
      this.dy = 3;
    }
  ...
  Micek_pohyb_closure: {
    "": "Closure:11;this_0",
    call$1: function(obj) {
      return this.this_0.kolize$1(obj);
    }
  },
  Cihla: {
    "": "HerniObjekt;zivot,powerup,skore,id,x,y,sirka,vyska,barva",
    nastavParametry$5: function(_x, _y, ziv, pow, skor) {
      this.x = _x;
      this.y = _y;
      this.zivot = ziv;
      this.powerup = pow;
    ...
    naraz$0: function() {
      ...
      if (t1 < 1) {
        ...
        t2 = t1 + t2;
        $.body = t2;
        if (C.JSNumber_methods.$mod(t2, 150) === 0) {
          T.randGen();
          t1 = $.micek;
          t2 = t1.dx;
          if (!(t2 === 10 || t2 === -10)) {
        ...
        if (this.powerup !== 0) {
          ...
          if (typeof t2 !== "number")
            return t2.$tdiv();
          t2 = C.JSInt_methods.toInt$0(t2 / 2 | 0);
          if (typeof t1 !== "number")
            return t1.$add();
          t3 = this.y;
          t4 = this.vyska;
          ...
          if (typeof t4 !== "number")
            return H.iae(t4);
          p = new T.PowerUp(null, null, new P.Stopwatch(null, null), null, null, null, null, null, null);
          p.PowerUp$3(t1 + t2, t3 + t4, this.powerup);
          $.get$pupy().push(p);
        }
        ret = true;
      } else
    ...
    Cihla$0: function() {
      this.sirka = 72;
      this.vyska = 34;
      this.id = $.get$cihly().length + 1;
    },
    static: {Cihla$: function() {
        var t1 = new T.Cihla(null, null, null, null, null, null, null, null, null);
        t1.Cihla$0();
        return t1;
      }}
  },
  PowerUp: {
    "": "HerniObjekt;id,cas,s<,sebran<,x,y,sirka,vyska,barva",
    kolize$0: function() {
      var t1 = this.s;
      t1.start$0(t1);
      switch (this.id) {
    ...
    nakresliSe$1: function(_ctx) {
      if (!this.sebran)
        T.HerniObjekt.prototype.nakresliSe$1.call(this, _ctx);
    },
    PowerUp$3: function(_x, _y, _id) {
      this.x = _x;
      this.y = _y;
      this.sirka = 10;
      this.vyska = 10;
...
T.PowerUp.$isObject = true;
T.Cihla.$isObject = true;
T.HerniObjekt.$isObject = true;
...
Isolate.$lazy($, "herniObjekty", "herniObjekty", "get$herniObjekty", function() {
  return H.setRuntimeTypeInfo([], [T.HerniObjekt]);
});
Isolate.$lazy($, "cihly", "cihly", "get$cihly", function() {
  return H.setRuntimeTypeInfo([], [T.Cihla]);
});
Isolate.$lazy($, "mazaneCihly", "mazaneCihly", "get$mazaneCihly", function() {
  return H.setRuntimeTypeInfo([], [T.Cihla]);
});
Isolate.$lazy($, "noveCihly", "noveCihly", "get$noveCihly", function() {
  return H.setRuntimeTypeInfo([], [T.Cihla]);
});
Isolate.$lazy($, "pupy", "pupy", "get$pupy", function() {
  return H.setRuntimeTypeInfo([], [T.PowerUp]);
});
Isolate.$lazy($, "mazanePower", "mazanePower", "get$mazanePower", function() {
  return H.setRuntimeTypeInfo([], [T.PowerUp]);
});
Isolate.$lazy($, "efekty", "efekty", "get$efekty", function() {
  return P.HashMap_HashMap(null, null, null, T.PowerUp, J.JSInt);
});
...
function dart_precompiled($collectedClasses) {
  ...
  function draw_closure() {
  }
  draw_closure.builtin$cls = "draw_closure";
  if (!"name" in draw_closure)
    draw_closure.name = "draw_closure";
  $desc = $collectedClasses.draw_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  draw_closure.prototype = $desc;
  function draw_closure0() {
  }
  draw_closure0.builtin$cls = "draw_closure0";
  if (!"name" in draw_closure0)
    draw_closure0.name = "draw_closure0";
  $desc = $collectedClasses.draw_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  draw_closure0.prototype = $desc;
  function draw_closure1() {
  }
  draw_closure1.builtin$cls = "draw_closure1";
  if (!"name" in draw_closure1)
    draw_closure1.name = "draw_closure1";
  $desc = $collectedClasses.draw_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  draw_closure1.prototype = $desc;
  ...
  function loop_closure0() {
  }
  loop_closure0.builtin$cls = "loop_closure0";
  if (!"name" in loop_closure0)
    loop_closure0.name = "loop_closure0";
  $desc = $collectedClasses.loop_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure0.prototype = $desc;
  function loop_closure1() {
  }
  loop_closure1.builtin$cls = "loop_closure1";
  if (!"name" in loop_closure1)
    loop_closure1.name = "loop_closure1";
  $desc = $collectedClasses.loop_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure1.prototype = $desc;
  function loop_closure2() {
  }
  loop_closure2.builtin$cls = "loop_closure2";
  if (!"name" in loop_closure2)
    loop_closure2.name = "loop_closure2";
  $desc = $collectedClasses.loop_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure2.prototype = $desc;
  function loop_closure3() {
  }
  loop_closure3.builtin$cls = "loop_closure3";
  if (!"name" in loop_closure3)
    loop_closure3.name = "loop_closure3";
  $desc = $collectedClasses.loop_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure3.prototype = $desc;
  function loop_closure4() {
  }
  loop_closure4.builtin$cls = "loop_closure4";
  if (!"name" in loop_closure4)
    loop_closure4.name = "loop_closure4";
  $desc = $collectedClasses.loop_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure4.prototype = $desc;
  function loop_closure5() {
  }
  loop_closure5.builtin$cls = "loop_closure5";
  if (!"name" in loop_closure5)
    loop_closure5.name = "loop_closure5";
  $desc = $collectedClasses.loop_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loop_closure5.prototype = $desc;
  function randGen_closure(box_0, c_1) {
    this.box_0 = box_0;
    this.c_1 = c_1;
  }
  randGen_closure.builtin$cls = "randGen_closure";
  if (!"name" in randGen_closure)
    randGen_closure.name = "randGen_closure";
  $desc = $collectedClasses.randGen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  randGen_closure.prototype = $desc;
  function HerniObjekt(x, y, sirka, vyska) {
    this.x = x;
    this.y = y;
    this.sirka = sirka;
    this.vyska = vyska;
  }
  HerniObjekt.builtin$cls = "HerniObjekt";
  if (!"name" in HerniObjekt)
    HerniObjekt.name = "HerniObjekt";
  $desc = $collectedClasses.HerniObjekt;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HerniObjekt.prototype = $desc;
  HerniObjekt.prototype.get$x = function(receiver) {
    return this.x;
  };
  HerniObjekt.prototype.get$y = function(receiver) {
    return this.y;
  };
  HerniObjekt.prototype.get$sirka = function() {
    return this.sirka;
  };
  HerniObjekt.prototype.get$vyska = function() {
    return this.vyska;
  };
  function Palka(x, y, sirka, vyska, barva) {
    this.x = x;
    this.y = y;
    this.sirka = sirka;
    this.vyska = vyska;
  ...
  Palka.builtin$cls = "Palka";
  if (!"name" in Palka)
    Palka.name = "Palka";
  $desc = $collectedClasses.Palka;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Palka.prototype = $desc;
  function Micek(dx, dy, docasneX, docasneY, novaSirka, novaVyska, x, y, sirka, vyska, barva) {
    this.dx = dx;
    this.dy = dy;
    this.docasneX = docasneX;
    this.docasneY = docasneY;
    this.novaSirka = novaSirka;
    this.novaVyska = novaVyska;
    this.x = x;
    this.y = y;
    this.sirka = sirka;
    this.vyska = vyska;
  ...
  Micek.builtin$cls = "Micek";
  if (!"name" in Micek)
    Micek.name = "Micek";
  $desc = $collectedClasses.Micek;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Micek.prototype = $desc;
  function Micek_pohyb_closure(this_0) {
    this.this_0 = this_0;
  }
  Micek_pohyb_closure.builtin$cls = "Micek_pohyb_closure";
  if (!"name" in Micek_pohyb_closure)
    Micek_pohyb_closure.name = "Micek_pohyb_closure";
  $desc = $collectedClasses.Micek_pohyb_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Micek_pohyb_closure.prototype = $desc;
  function Cihla(zivot, powerup, skore, id, x, y, sirka, vyska, barva) {
    this.zivot = zivot;
  ...
  Cihla.builtin$cls = "Cihla";
  if (!"name" in Cihla)
    Cihla.name = "Cihla";
  $desc = $collectedClasses.Cihla;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Cihla.prototype = $desc;
  function PowerUp(id, cas, s, sebran, x, y, sirka, vyska, barva) {
    this.id = id;
    this.cas = cas;
    this.s = s;
    this.sebran = sebran;
  ...
  PowerUp.builtin$cls = "PowerUp";
  if (!"name" in PowerUp)
    PowerUp.name = "PowerUp";
  $desc = $collectedClasses.PowerUp;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PowerUp.prototype = $desc;
  PowerUp.prototype.get$s = function() {
    return this.s;
  };
  PowerUp.prototype.get$sebran = function() {
    return this.sebran;
  };
